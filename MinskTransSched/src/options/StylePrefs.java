...
public class StylePrefs extends Form implements CommandListener
{
	...
	void SaveSettings()
	{
		...
		Options.textColor = (Integer.parseInt(tfTextColorR.getString()) << 16)
			| (Integer.parseInt(tfTextColorG.getString()) << 8)
			| Integer.parseInt(tfTextColorB.getString());

		Options.favoritesColor = (Integer.parseInt(tfFavColorR.getString()) << 16)
			| (Integer.parseInt(tfFavColorG.getString()) << 8)
			| Integer.parseInt(tfFavColorB.getString());
